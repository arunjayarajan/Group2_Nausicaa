# ProjTemplate
MScDevOps Assign - Group 2 : Nausicaä’s Global Green Initiative would like an online application system for range of grants to support climate change initiatives.
